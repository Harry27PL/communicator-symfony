...
class Autop extends \Twig_Extension
{
    private $environment;
    ...
    {
        return array(
            'autop'    => new \Twig_Function_Method($this, 'autop',   array('is_safe' => array('html'))),
        );
    }

    public function autop($pee, $raw = false, $br = true)
    {
        if (!$raw)
            $pee = htmlspecialchars($pee);
